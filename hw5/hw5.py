...
row_space_4 = [list2vec(v) for v in [[1,2],[0,1]]]
...
a2 = Vec({'a','b','c','d'}, {'c':1})
a3 = Vec({'a','b','c','d'}, {'a':1,'c':3})
#print(subset_basis([a0,a1,a2,a3]) == [Vec({'c', 'b', 'a', 'd'},{'a': 1}), Vec({'c', 'b', 'a', 'd'},{'b': 1}), Vec({'c', 'b', 'a', 'd'},{'c': 1})])
...
def direct_sum_decompose(U_basis, V_basis, w):
    ...
    True
    '''
    W_basis=coldict2mat(U_basis+V_basis)
    return solve(W_basis,w)
...
def find_matrix_inverse(A):
    ...
    return coldict2mat([solve(A,i[col]) for col in i])





#== Mat(({0, 1, 2}, {0, 1, 2}), {(0, 1): one, (2, 0): 0, (0, 0): 0, (2, 2): one, (1, 0): one, (1, 2): 0, (1, 1): 0, (2, 1): 0, (0, 2): 0})
...
def find_triangular_matrix_inverse(A): 
    ...
    '''
    pass
help(triangular.triangular_solve)