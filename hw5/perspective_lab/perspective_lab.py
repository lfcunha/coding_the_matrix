...
## Task 3
L_rows = make_equations(358,36,0,0)
L_rows.extend(make_equations(329,597,0,1))
L_rows.extend(make_equations(592,157,1,0))
L_rows.extend(make_equations(580,483,1,1))
L_rows.append(Vec(domain, {('y1','x1' ):1}))

L = rowdict2mat(L_rows)
...
def mat_move2board(Y):
    ...
    '''
    cols = mat2coldict(Y)
    moved = { k:move2board(cols[k]) for k in cols.keys() }
    return coldict2mat(moved)
